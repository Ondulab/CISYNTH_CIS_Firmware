...
void MX_TIM2_Init(void)
{
  ...
  /* USER CODE BEGIN TIM2_Init 1 */
	...
	prescalerValue = (uint32_t)(((SystemCoreClock) / (IMU_CLKIN_FREQ)) - 1);
	counterPeriod = 100 - 1;
	pulseValue = 50 - 1;
  ...
  htim2.Init.Period = counterPeriod;
...
void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = prescalerValue;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA15 (JTDI)     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = MEMS_CLKIN_FSYNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(MEMS_CLKIN_FSYNC_GPIO_Port, &GPIO_InitStruct);
