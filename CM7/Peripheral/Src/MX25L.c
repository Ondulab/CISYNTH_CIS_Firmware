            ...
            SCLK = 0;
				if(!flash_bank_flag)
					P1 = (byte_value & 0xf0);
 					...
 					P3 = ((byte_value & 0xf0)>>4)|(P3 & 0xf0);  // CS# and SCLK must be zero at this phase
    ...
    case DTSIO: //  Double transfer rate single I/O
         ...
         for( i= 0; i < cycle_cnt; i++ )
        {
            SCLK = 0;
            	...
            	SIO4 = ( (byte_value & IO_MASK) == IO_MASK)?1:0;
            byte_value = byte_value << 1;
